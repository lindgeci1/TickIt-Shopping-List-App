...
use App\Application\UseCases\Product\Get_All_Products_Use_Case;
...
use App\Application\UseCases\Market\Get_All_Markets_Only_Use_Case;
...
use App\Application\UseCases\Product_Market\Remove_Markets_From_Product_Use_Case;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        // Market Services
        $this->app->bind(I_Get_All_Markets_Use_Case::class, Get_All_Markets_Use_Case::class);
        $this->app->bind(I_Get_Market_Use_Case::class, Get_Market_Use_Case::class);
        ...
        $this->app->bind(I_Get_All_Markets_Only_Use_Case::class, Get_All_Markets_Only_Use_Case::class);
        // ShoppingListItem Services
        $this->app->bind(I_Get_All_Shopping_List_Items_Use_Case::class, Get_All_Shopping_List_Items_Use_Case::class);
