...
class MarketController extends Controller
{
     ...
     *         @OA\JsonContent(type="array", @OA\Items(ref="#/components/schemas/MarketDto"))
     *     )
     * )
     */
     ...
     *     @OA\RequestBody(required=true, @OA\JsonContent(ref="#/components/schemas/MarketDto")),
     *     @OA\Response(response=200, description="Updated market", @OA\JsonContent(ref="#/components/schemas/MarketDto")),
     *     @OA\Response(response=400, description="Validation error"),
     *     @OA\Response(response=404, description="Market not found")
     * )
     */
