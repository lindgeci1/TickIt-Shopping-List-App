...
Route::prefix('shopping-list-item-product-market')->group(function () {
    ...
    Route::delete('/product/{ProductID}/shopping-list/{ShoppingListItemID}/remove', [Shopping_List_Item_Product_Market_Controller::class, 'removeProductFromMarketShoppingListItem']);
});
